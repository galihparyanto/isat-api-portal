...
class USSDAuthentication extends Component {
    componentDidMount() {
    }

    render() {
        return (
            <div className="USSDAuthentication">
                <ScrollToTopOnMount/>
                <div className="container navigation">
                    <p><Link className="navigation-link" to="/">Home</Link> \ <Link className="navigation-link" to="/use-cases">Use Case</Link>  \ <span className="navigation-detail">USSD Push Authentication</span></p>
                </div>
                ...
                <div className="container use-case-detail">
                    <div className="row">
                        ...
                        <div className="col-md-9 order-md-2 product-detail-text">
                            ...
                            <p>Add security layer prior to transaction by sending confirmation/Authentication to user’s mobile phone. Connect each user with their valid mobile number via USSD Push and use it as a trust anchor for authentication & communication throughout the account lifecycle.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray">
                    ...
                    <div className="row">
                        <img className="img-fluid sms-authentication-step-img mx-auto" src={process.env.PUBLIC_URL + "/img/ussd-authentication-step.png"}/>
                    </div>
...
export default USSDAuthentication;
