...
class USSDNotification extends Component {
    componentDidMount() {
    }

    render() {
        return (
            <div className="USSDNotification">
                <ScrollToTopOnMount/>
                <div className="container navigation">
                    <p><Link className="navigation-link" to="/">Home</Link> \ <Link className="navigation-link" to="/use-cases">Use Case</Link>  \ <span className="navigation-detail">USSD Push Notification</span></p>
                </div>
                ...
                <div className="container use-case-detail">
                    <div className="row">
                        ...
                        <div className="col-md-9 order-md-2 product-detail-text">
                            <p className="text-header">USSD Push Notification</p>
                            <p>Send your message through 1-way USSD Push to millions of Indosat Ooredo’s subscribers. Use USSD Push Notification to notify and instantly reach your customers. Program your USSD Push based on your needs and pay only for what you use.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="benefit-items">
                            ...
                            <div className="benefit-row">
                                ...
                                <div className="row benefit-item">
                                    ...
                                    <div className="col-md-11 no-padding">
                                        <span>Gift your customers for special discount or voucher as USSD Push Notification</span>
                                    </div>
                                </div>
                            </div>
                            {/*<div className="row benefit-item">*/}
                ...
                <div className="bg-gray">
                    ...
                    <div className="row">
                        <img className="img-fluid use-case-step-img mx-auto" src={process.env.PUBLIC_URL + "/img/ussd-notification-step.png"}/>
                    </div>
